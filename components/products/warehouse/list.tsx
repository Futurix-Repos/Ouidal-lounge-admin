...
import DelProduct from "@/components/modals/del-product";
...
export default function Products() {
  ...
  return (
    <>
      ...
      <DelProduct open={openDelete} setOpen={setOpenDelete} />
      {isLoading ? (
        ...
        <ul
          role="list"
          className="grid mt-8 grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-3 xl:gap-x-8 p-4"
        >
              ...
              >
                ...
                <dl className="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                  ...
                  {product.sellingPerUnit.isTrue ? (
                    ...
                    <p className="mt-4 p-2">Non vendu à la consommation.</p>
                  )}
                </dl>
              </li>
            );
