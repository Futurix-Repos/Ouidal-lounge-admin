...
export default function OrdersList() {
  const [currentOrder, setCurrentOrder] = useState({table: "", zone: "", items: [], id: ""})
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="p-6 inline-flex w-72 items-center rounded-md bg-white  text-lg font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:bg-white">
        ...
        <div className="space-x-2 w-full inline-flex"> 
          <div className={clsx("transition duration-200 -mx-4 mt-10 ring-1 ring-gray-300 sm:mx-0 sm:rounded-lg inline-block", open ? "w-2/3" : "w-full")}>
                  ...
                  {orders?.map((order, orderIdx) => (
                    <tr key={order.id}>
                      ...
                      >
                        ...
                        className={clsx(
                          "h-1.5 w-1.5 ",
                          order.id === currentOrder.id ? "fill-green-600" : "fill-gray-300"
                        )}
                        viewBox="0 0 6 6"
                        aria-hidden="true"
                      >
          ...
          <Items order={currentOrder} setOrder={setCurrentOrder} open={open} setOpen={setOpen} />
      </div>
