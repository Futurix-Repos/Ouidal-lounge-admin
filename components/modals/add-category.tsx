...
export default function AddCategory({open, setOpen}: any) {
                    ...
                    >
                      ...
                      <div className="w-full flex items-start flex-col">
                        ...
                        <select
                          ...
                          className="w-full border p-2 block  rounded-md h-12 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        >
                          {stands?.map((stand) => (
